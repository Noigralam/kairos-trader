...
SPOT_DCA_DROP_PCT        = float(os.getenv("SPOT_DCA_DROP_PCT", "0.04"))          # price drop from entry that triggers DCA
SPOT_DCA_SIZE_PCT        = float(os.getenv("SPOT_DCA_SIZE_PCT", "0.50"))          # fraction of remaining balance used for DCA tranche
